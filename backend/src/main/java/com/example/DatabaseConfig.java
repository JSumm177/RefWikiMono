...
public class DatabaseConfig {
    ...
    static {
        ...
        if (dbHost == null || dbPort == null || dbName == null || dbUser == null || dbPass == null) {
            ...
            if (System.getProperty("IS_TEST_ENV") != null) {
                ...
                if (dbHost == null || dbPort == null || dbName == null || dbUser == null || dbPass == null) {
                    throw new RuntimeException("Database system properties (DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASSWORD) must be set for tests.");
                }
            } else {
    ...
    private static void initHibernateSessionFactory(DataSource ds) {
        try {
            ...
            configuration.addAnnotatedClass(com.example.CallLog.class);
            configuration.addAnnotatedClass(com.example.Sport.class);
            configuration.addAnnotatedClass(com.example.Rulebook.class);
            configuration.addAnnotatedClass(com.example.RuleEntity.class);
            ...
            configuration.addAnnotatedClass(com.example.UserProfile.class);
            configuration.addAnnotatedClass(com.example.UserHomeTeam.class);
            configuration.addAnnotatedClass(com.example.Team.class);
