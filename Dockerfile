...
# We do this FIRST so the frontend assets overlay cleanly and don't get accidentally overwritten
...
# Copy built frontend to Tomcat ROOT app, overlaying the Java app
